...
public class ViFile {
	...
	public final com.openthinks.vimixer.ui.model.ViFileStatus getStatus() {
		return this.statusProperty().get();
	}

	public final void setStatus(final com.openthinks.vimixer.ui.model.ViFileStatus status) {
	...
	public final com.openthinks.vimixer.ui.model.ViFileInfo getInfo() {
		return this.infoProperty().get();
	}

	public final void setInfo(final com.openthinks.vimixer.ui.model.ViFileInfo info) {
